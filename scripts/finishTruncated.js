...
ПРАВИЛА:
- Начни ровно с того места, где текст оборвался. Если оборвано слово — первым же символом допиши это слово. Никаких вводных, никаких «продолжим».
...
${"=".repeat(70)}`);
    ...
    try {
      ...
      // Пробел между частями не ставим: обрыв мог случиться посреди слова,
      // и пробел разорвал бы его окончательно.
