...
const newsSchema = new mongoose.Schema(
  {
    ...
    //   no_full_text — полного текста нет и достать его нельзя: протухшая
    //                 ссылка или страница без содержания. Карточка обещала бы
    //                 «читать полностью» и приводила к 404.
    //   paywalled   — текст ОБОРВАН платной стеной: в нём стоит «To read the
    //                 rest of this story subscribe». Такой материал набирает
    //                 полторы тысячи знаков за счёт биографии автора и формы
    //                 подписки, проходит проверку длины и выглядит статьёй.
    excludedReason: {
      type: String,
      enum: ["", "retraction", "correction", "concern", "editorial", "no_full_text", "paywalled"],
      default: "",
    },
    translations: {
      type: Map,
